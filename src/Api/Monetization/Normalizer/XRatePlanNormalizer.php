...
abstract class XRatePlanNormalizer extends EntityNormalizer
{
    use TimezoneFixerHelperTrait;

    /**
     * XRatePlanNormalizer constructor.
     *
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        /** @var \Apigee\Edge\Api\Monetization\Entity\XRatePlanInterface $object */
        if (null === $object->getPackage()) {
            throw new UninitializedPropertyException($object, 'package', 'Apigee\Edge\Api\Monetization\Entity\ApiXProductInterface');
        }
    ...
    {
        return $data instanceof XRatePlanInterface;
    }
}
