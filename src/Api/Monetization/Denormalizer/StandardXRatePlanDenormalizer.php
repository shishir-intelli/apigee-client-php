...
use Apigee\Edge\Api\Monetization\Entity\StandardXRatePlanRevision;

class StandardXRatePlanDenormalizer extends XRatePlanDenormalizer
{
    /**
     ...
     * @var string
     */
    protected $standardRatePlanClass = StandardXRatePlan::class;
     ...
     * @var string
     */
    protected $standardRatePlanRevisionClass = StandardXRatePlanRevision::class;
    ...
    public function supportsDenormalization($data, $type, $format = null)
    {
        ...
        if (parent::supportsDenormalization($data, $type, $format)) {
            //return XRatePlanInterface::TYPE_STANDARD == $data->type;
            return XRatePlanInterface::TYPE_STANDARD == "STANDARD";
        }
