...
class XRatePlanDenormalizerFactory implements DenormalizerInterface, SerializerAwareInterface
{
    ...
    /**
     * XRatePlanDenormalizerFactory constructor.
     *
    ...
    public function __construct(array $denormalizers = [])
    {
        $this->denormalizers = array_merge($denormalizers, [
            new StandardXRatePlanDenormalizer(),
